...
4) При переключении на вкладку "Достижения" возможна сортировка и просмотр ранее введенных и записанных в базе данных упражнений и их характеристик, а также их удаление.
